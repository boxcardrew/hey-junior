      ...
      <Layout>
        <main>
          <section>
            ...
            <p>Welcome to heyjunior.co!</p>

            <p>
              These terms and conditions outline the rules and regulations for
              the use of HeyJunior's Website, located at https://heyjunior.co.
            </p>

            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use heyjunior.co if you do not
            ...
            <p>
              We employ the use of cookies. By accessing heyjunior.co, you
              agreed to use cookies in agreement with the HeyJunior's Privacy
              Policy.{" "}
            </p>
            ...
            <p>
              Unless otherwise stated, HeyJunior and/or its licensors own the
              intellectual property rights for all material on heyjunior.co. All
              intellectual property rights are reserved. You may access this
              from heyjunior.co for your own personal use subjected to
              restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from heyjunior.co</li>
              <li>Sell, rent or sub-license material from heyjunior.co</li>
              <li>Reproduce, duplicate or copy material from heyjunior.co</li>
              <li>Redistribute content from heyjunior.co</li>
            </ul>
            ...
            <p>
              ...
              HeyJunior does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of HeyJunior,its agents and/or affiliates.
              ...
              laws, HeyJunior shall not be liable for the Comments or for any
            ...
            <p>
              HeyJunior reserves the right to monitor all Comments and to remove
            ...
            <p>
              You hereby grant HeyJunior a non-exclusive license to use,
            ...
            <p>
              ...
              HeyJunior; and (d) the link is in the context of general resource
              information.
            </p>
            ...
            <p>
              ...
              by sending an e-mail to HeyJunior. Please include your name, your
            ...
            <p>
              No use of HeyJunior's logo or other artwork will be allowed for
